...
\begin{document} 
	...
	\vspace{1cm}
	{\Huge\textbf{BÁO CÁO \\ \hspace{0.5cm} ĐỒ ÁN MÔN HỌC\\PHÂN TÍCH VÀ XỬ LÝ ẢNH}\par}
	\vspace{3cm}
...
\begin{titlingpage} %BÌA PHỤ II
	...
	{\huge\textbf{BÁO CÁO \\ \hspace{0.5cm} ĐỒ ÁN MÔN HỌC \\
...
Cấu trúc của báo cáo được tổ chức thành một chương như sau: Trình bày chi tiết về xử lý ảnh trong miền tần số, bao gồm giới thiệu về miền tần số, khác biệt giữa miền không gian và miền tần số, khái niệm chuỗi Fourier và biến đổi Fourier, các phương pháp lọc ảnh trong miền tần số (lọc thông thấp, lọc thông cao, lọc chặn) và ứng dụng thực tế của chúng. Phần kết luận tổng hợp lại những nội dung chính.
	...
	\rightline{\textbf{Nhóm sinh viên} \hspace*{2cm}}
...
Bài báo cáo này được hoàn thành tại trường Đại Học Sài Gòn dưới sự hướng dẫn của \textit{PGS.TS. Phạm Thế Bảo}. Em xin bày tỏ lòng biết ơn chân thành và sâu sắc về sự tận tâm và nhiệt tình của Thầy trong suốt quá trình tác giả thực hiện đề tài.
...
IDFT & Inverse Discrete Fourier Transform  \\ \hline
ILPF & Ideal Low-Pass Filter (Bộ lọc thông thấp lý tưởng) \\ \hline
BLPF & Butterworth Low-Pass Filter (Bộ lọc thông thấp Butterworth) \\ \hline
GLPF & Gaussian Low-Pass Filter (Bộ lọc thông thấp Gaussian) \\ \hline
IHPF & Ideal High-Pass Filter (Bộ lọc thông cao lý tưởng) \\ \hline
BHPF & Butterworth High-Pass Filter (Bộ lọc thông cao Butterworth) \\ \hline
GHPF & Gaussian High-Pass Filter (Bộ lọc thông cao Gaussian) \\ \hline
...
Một số hình ảnh áp dụng bộ lọc :
\begin{figure}[H]
\centering
...
\end{figure}
    ...
    Như vậy ta đã giảm nhiễu và mờ đi các đường sọc chéo caro của ảnh ban đầu và nhìn tổng thể bức hình sẽ tốt hơn, không gây khó chịu khi nhìn lâu vào các điểm sọc caro.
    \\
