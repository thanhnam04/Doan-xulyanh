...
\begin{equation}
	\label{134}
    \mathcal{F}\{f(t)\}(\mu)=\int_{-\infty}^{+\infty}f(t)e^{-i2\pi\mu t}dt
\end{equation}
...
\begin{equation}
	\label{135}
  \mathcal{F}(\mu)=\int_{-\infty}^{+\infty}f(t)e^{-i2\pi\mu t}dt
\end{equation}
...
\begin{equation}
	\label{136}
    f(t)=\int_{-\infty}^{+\infty}\mathcal{F}(\mu)e^{i2\pi\mu t}d\mu,
\end{equation}
...
\begin{equation}
	\label{137}
     \mathcal{F}(\mu)=\int_{-\infty}^{+\infty}f(t)[\cos(2\pi\mu t)-i\sin(2\pi\mu t)]dt.
\end{equation}
