...
\begin{table}[H]
\centering
\caption{Tổng hợp đặc điểm và tác dụng của lọc thông thấp Butterworth }
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Nội dung} & \textbf{Mô tả} \\ \hline
Ảnh gốc & Có nhiều chi tiết và biên rõ nét, chứa cả tần số thấp và cao \\ \hline
Ảnh sau lọc & Các chi tiết nhỏ bị làm mờ, nhưng cấu trúc tổng thể của ảnh vẫn nhận thấy rõ \\ \hline
Độ mịn & Tăng vừa phải, ảnh trở nên mượt nhưng không bị nhòe hoàn toàn \\ \hline
Độ sắc nét & Giảm nhẹ, vẫn còn giữ được biên mềm và vùng chuyển tiếp tự nhiên \\ \hline
Phổ tần số ảnh gốc & Phân bố năng lượng tương đối rộng, bao gồm cả vùng trung tâm và rìa \\ \hline
Phổ tần số sau lọc & Biên độ giảm dần mượt từ tâm ra rìa, không cắt gắt như Ideal \\ \hline
Tác dụng chính & Làm mờ nhiễu cao tần, đồng thời vẫn giữ được thông tin chính của ảnh \\ \hline
Cơ chế hoạt động & Giảm biên độ tần số cao theo hàm bậc $n$ của Butterworth, thay vì loại bỏ hoàn toàn \\ \hline
Ưu điểm & Ảnh sau lọc trơn, tự nhiên; không có hiệu ứng chuông, có thể điều chỉnh mức mờ qua bậc $n$ \\ \hline
Ứng dụng & Làm mượt ảnh, khử nhiễu trong xử lý ảnh y tế hoặc ảnh vệ tinh, nơi cần cân bằng giữa mờ và chi tiết \\ \hline
\end{tabular}
\end{table}
